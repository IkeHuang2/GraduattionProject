...
import com.hyz.mapper.EmployeeMapper;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    public List<Employee> selectFromTwoTabletToShowCoachInformation() {
        return employeeMapper.selectFromTwoTabletToShowCoachInformation();
    }
}
