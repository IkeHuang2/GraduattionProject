...
public class UserController {
    ...
    public String userApplyClass(Integer classId, Model model, HttpSession session) {
        ...
        System.out.println(classOrder1);
        if (classOrder1 == null) {
    ...
    public String toVideoPage(Video video,Model model) {
    ...
    @RequestMapping("/toUserSelectPrivateClass")
    public String toUserSelectPrivateClass(Model model){
        List<Employee> employeeList=employeeService.selectFromTwoTabletToShowCoachInformation();
